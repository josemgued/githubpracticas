 <div class="row">
    <div class="col-xs-12 col-lg-6 col-md-7">
        <div class="card">
            <div class="header">
                <h2>Lista de Cargos de Empresa</h2> 
            ...
            <div class="body table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <script type="handlebars-x" id="tpl8Cargo_Tabla">
                        {{#.}}
                        <tr>
                        <th>
                        <button type="button" onclick="app.editar({{cod_cargo}})" 
                        class="btn btn-sm bg-blue waves-effect"><i class="material-icons col-blue">edit</i></button>
                        <button type="button" onclick="app.eliminar({{cod_cargo}})" 
                        ...
                        {{^.}}
                        <tr class="null-td">
                        <td colspan="2" class="text-center"><i>No hay cargos registrados</i>                               
                        </tr>
                        {{/.}}
                        </script>
                    </tbody>
