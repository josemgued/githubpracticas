<div class="row">
            <div class="col-xs-12 col-sm-8 col-lg-6">
                    <div class="card">
                        <div class="header">
                            <h2>Lista de Sectores Industriales</h2> 
                        ...
                        <div class="body table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <script type="handlebars-x" id="tpl8SectorIndustrial_Tabla">
                                             {{#.}}
                                                <tr>
                                                      <th>
                                                        <button type="button" onclick="app.editar({{cod_sector_industrial}})" 
                                                            class="btn btn-sm bg-blue waves-effect"><i class="material-icons col-blue">edit</i></button>
                                                            <button type="button" onclick="app.eliminar({{cod_sector_industrial}})" 
                                            ...
                                            {{^.}}
                                                <tr class="null-td">
                                                    <td colspan="2" class="text-center"><i>No hay sectores industriales registradas</i> 
                                                </tr>
                                            {{/.}}
                                            </script>
                                        </tbody>
