...
class Mensaje {
    ...
    private function enviarCorreoPreseleccionar(){
        ...
        $data = Funciones::enviarCorreo($mail, SMTP::DEBUG_SERVER, PHPMailer::ENCRYPTION_SMTPS, $this->asunto,$this->getMensajeArmado(),$this->empresa,trim($estudiante["correo"]));
    ...
    private function enviarCorreoConfirmacion(){
        ...
        $mail = new PHPMailer(true);
        $data = Funciones::enviarCorreo($mail, SMTP::DEBUG_SERVER, PHPMailer::ENCRYPTION_SMTPS, $this->asunto,$this->getMensajeArmado(),$this->empresa,trim($persona["correo"]));
